...
# ── Service ──────────────────────────────────────────────────────────────
PORT = int(os.environ.get("PORT", 9290))    # PROD
...
# ── Cross-service read paths (decoupled, house pattern) — PROD siblings ──
NS8_HIST = Path("/Users/chuck/Project_Alpha_POC/Project_Nine_Street/NS-8_PROD/data/ns8_hist_closes.json")
NS7_SELECTION = Path("/Users/chuck/Project_Alpha_POC/Project_Nine_Street/NS-7_PROD/data/selection.json")
NS7_WF = Path("/Users/chuck/Project_Alpha_POC/Project_Nine_Street/NS-7_PROD/data/walkforward_results.json")
NS7_BLEND = Path("/Users/chuck/Project_Alpha_POC/Project_Nine_Street/NS-7_PROD/data/blend_results.json")
