...
<body>
  <div class="topbar">
    <div class="topbar-left">
      <div class="logo"><span>Trading Strategy Engine</span><div style="font-size: 9px; color: #8b949e; margin-left: 8px; white-space: nowrap;">v3.7.0 | Last Updated: {last_updated}</div></div>
      <div class="nav-tabs">
