...
bt = NSBacktester(tickers=universe, start_date="2010-01-01")
...
print(f"Strat CAGR: {res['cagr_pct']:.2f}% | SPY CAGR: {res['benchmark_cagr_pct']:.2f}%")
...
# Extract last target weights to pass to portfolio allocator
import json
latest_weights = None
# We'd have to parse stdout or extract from bt... Let's just do it directly.
